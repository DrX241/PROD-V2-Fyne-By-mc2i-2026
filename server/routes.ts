...
Analyse cette justification selon les critères spécifiés et retourne ton évaluation au format JSON.`;
  ...
  const MTM_BANK: Record<string, MTMScenario[]> = {
    debutant: [
      ...
      { category:'phishing-sncf', title:'Votre billet SNCF annulé', context:'Vous avez réservé un trajet Paris-Lyon. Ce SMS arrive.', visual:{type:'sms',from:'SNCF Connect',body:'Votre réservation TGV INOUI Paris-Lyon (15/04 — 14h28) a été annulée suite à une erreur de paiement.\n\nRéservez à nouveau avant 23h59 pour garder votre tarif :\nhttps://sncf-connect-rebooking.fr/reservation/retry',hasClickableLink:true,linkLabel:'https://sncf-connect-rebooking.fr',linkUrl:'https://sncf-connect-rebooking.fr/reservation/retry'}, choices:[{label:'Je clique pour re-réserver avant minuit',isCorrect:false,feedback:'Vos coordonnées bancaires sont volées. Votre billet original est en réalité parfaitement valide.',points:-5},{label:'Je vérifie sur l\'app SNCF Connect officielle',isCorrect:true,feedback:'Parfait ! Votre réservation est visible dans votre compte SNCF Connect.',points:10},{label:'Je rappelle la SNCF avec le numéro dans le SMS',isCorrect:false,feedback:'Ce numéro appartient aux fraudeurs. Appelez le 3635 ou vérifiez sur l\'app.',points:-5}], reflexe:'Vérifiez vos réservations SNCF uniquement sur l\'app officielle ou le 3635.', clickConsequence:'Fausse page SNCF qui vole vos identifiants et coordonnées bancaires.', redFlags:['Domaine sncf-connect-rebooking.fr pas sncf.com','Urgence artificielle (avant minuit)','La SNCF ne demande pas de re-réserver par SMS'] },
      { category:'vishing-banque', title:'Votre conseiller bancaire vous appelle', context:'Vous recevez un appel affiché comme votre numéro de banque habituel.', visual:{type:'phone-call',from:'Société Générale — 0800 902 902',body:'Bonjour, je suis Mathieu, conseiller Société Générale. Nous avons bloqué une tentative de virement frauduleux de 1 200€ sur votre compte. Pour confirmer votre identité et annuler cette opération, j\'ai besoin de votre code à usage unique que vous venez de recevoir par SMS.',hasClickableLink:false}, choices:[{label:'Je lui donne le code SMS pour annuler le virement',isCorrect:false,feedback:'Vous venez d\'autoriser le virement frauduleux. Les vrais conseillers ne demandent jamais les codes OTP.',points:-5},{label:'Je raccroche et rappelle le numéro affiché sur ma carte',isCorrect:true,feedback:'Parfait ! Les numéros peuvent être usurpés. Rappelez toujours sur le numéro officiel de votre carte.',points:10},{label:'Je demande le numéro de dossier avant de donner quoi que ce soit',isCorrect:false,feedback:'Les fraudeurs ont des réponses préparées. Raccrochez et rappelez le vrai numéro.',points:-5}], reflexe:'Jamais de code OTP par téléphone — même si le numéro affiché semble correct.', redFlags:['Le numéro affiché peut être usurpé (spoofing)','Un vrai conseiller ne demande jamais votre code OTP','Urgence inventée pour vous faire agir vite'] },
      { category:'arnaque-romantique', title:'Rencontre en ligne trop parfaite', context:'Vous chattez depuis 3 semaines avec quelqu\'un sur un site de rencontre.', visual:{type:'social-post',from:'James Mitchell — Ingénieur pétrolier',body:'Ma chérie,\n\nJe dois te confier quelque chose. Je suis coincé sur la plateforme pétrolière en mer du Nord, mon contrat se termine dans 10 jours et je vais enfin pouvoir te rejoindre.\n\nMais j\'ai un problème urgent : mon compte bancaire est bloqué à cause d\'un problème administratif. J\'ai besoin de 800€ pour payer les frais consulaires et partir. Je te rembourse dès mon retour. Je t\'aime ❤️',hasClickableLink:false}, choices:[{label:'J\'envoie les 800€, c\'est la personne que j\'aime',isCorrect:false,feedback:'Vous ne le reverrez jamais. Cette arnaque dure généralement 3-6 semaines pour créer un attachement émotionnel fort.',points:-5},{label:'Je propose de contacter directement le consulat à sa place',isCorrect:true,feedback:'Parfait ! La demande d\'argent par virement est le signal final de l\'arnaque.',points:10},{label:'Je demande une vidéo en direct pour vérifier son identité',isCorrect:false,feedback:'Les deepfakes permettent maintenant les fausses vidéos en temps réel. Refusez le virement.',points:-5}], reflexe:'Toute relation en ligne qui débouche sur une demande d\'argent est une arnaque.', redFlags:['3 semaines de conversation intense (love bombing)','Toujours une raison de ne pas se voir en vrai','Première demande d\'argent après investissement émotionnel'] },
      { category:'phishing-pole-emploi', title:'Prime France Travail à réclamer', context:'Vous êtes inscrit à France Travail. Vous recevez cet email.', visual:{type:'email',from:'France Travail — Service Prestations',fromEmail:'prestations@francetravail-fr.eu',subject:'Prime exceptionnelle de 250€ — À valider avant le 31 mars',body:'Madame, Monsieur,\n\nDans le cadre du plan de soutien à l\'emploi, France Travail vous verse une prime exceptionnelle de 250€.\n\nPour recevoir cette prime, veuillez confirmer vos coordonnées bancaires en cliquant ci-dessous avant le 31 mars.\n\nService Prestations — France Travail',hasClickableLink:true,linkLabel:'Confirmer mes coordonnées pour recevoir la prime',linkUrl:'https://francetravail-fr.eu/prime/confirm-rib'}, choices:[{label:'Je confirme mes coordonnées pour recevoir les 250€',isCorrect:false,feedback:'France Travail ne distribue pas de primes par email. Vos coordonnées bancaires sont volées.',points:-5},{label:'Je me connecte sur francetravail.fr pour vérifier',isCorrect:true,feedback:'Parfait ! France Travail communique uniquement via votre espace personnel sur francetravail.fr.',points:10},{label:'J\'appelle le 3949 pour vérifier l\'information',isCorrect:false,feedback:'Bonne idée de vérifier, mais attention à l\'attente — commencez par votre espace en ligne.',points:-5}], reflexe:'France Travail ne demande jamais de coordonnées bancaires par email.', clickConsequence:'Fausse page France Travail qui collecte votre RIB pour des prélèvements frauduleux.', redFlags:['Domaine francetravail-fr.eu pas francetravail.fr','France Travail a déjà votre RIB','Prime surprise non annoncée = signal d\'alarme'] },
      { category:'arnaque-edf', title:'Coupure EDF imminente', context:'Ce SMS arrive un vendredi soir à 18h30.', visual:{type:'sms',from:'EDF — Alerte Facturation',body:'Votre facture EDF de 187€ est impayée depuis 30 jours. Sans règlement aujourd\'hui avant 20h, votre électricité sera coupée ce soir.\n\nRéglez immédiatement : https://edf-paiement-urgent.fr/facture?ref=FR9182',hasClickableLink:true,linkLabel:'https://edf-paiement-urgent.fr',linkUrl:'https://edf-paiement-urgent.fr/facture?ref=FR9182'}, choices:[{label:'Je paie immédiatement pour garder l\'électricité',isCorrect:false,feedback:'EDF n\'effectue pas de coupures sans plusieurs courriers recommandés au préalable.',points:-5},{label:'Je vérifie sur mon espace client edf.fr',isCorrect:true,feedback:'Parfait ! EDF procède toujours par courriers officiels avant toute coupure. Vérifiez votre espace client.',points:10},{label:'J\'appelle le numéro indiqué dans le SMS',isCorrect:false,feedback:'Ce numéro appartient aux fraudeurs. Appelez le 09 69 32 15 15 (EDF officiel).',points:-5}], reflexe:'EDF n\'effectue jamais de coupures d\'urgence annoncées par SMS.', clickConsequence:'Votre carte bancaire est débitée de la fausse facture et enregistrée pour de futurs prélèvements.', redFlags:['Urgence créée le vendredi soir','EDF utilise des courriers recommandés','Domaine edf-paiement-urgent.fr pas edf.fr'] },
      { category:'phishing-doctolib', title:'Rappel de rendez-vous Doctolib', context:'Vous avez un rendez-vous médical programmé.', visual:{type:'email',from:'Doctolib',fromEmail:'rappel@doctolib-rappel-rdv.com',subject:'Rappel : Votre rendez-vous demain — Confirmation requise',body:'Bonjour,\n\nVotre rendez-vous chez Dr. Dupont est programmé demain à 10h30.\n\nPour confirmer votre présence et maintenir le créneau, cliquez sur le lien ci-dessous.\n\nSi vous ne confirmez pas dans l\'heure, le créneau sera libéré pour un autre patient.',hasClickableLink:true,linkLabel:'Confirmer mon rendez-vous',linkUrl:'https://doctolib-rappel-rdv.com/confirm?token=fr8472kd'}, choices:[{label:'Je confirme via le lien pour garder mon créneau',isCorrect:false,feedback:'Vous atterrissez sur une fausse page qui demande vos identifiants Doctolib et votre carte bancaire.',points:-5},{label:'Je vérifie dans l\'app Doctolib officielle',isCorrect:true,feedback:'Parfait ! Tous vos rendez-vous sont visibles directement dans l\'app Doctolib.',points:10},{label:'J\'ignore l\'email, j\'ai déjà confirmé',isCorrect:false,feedback:'Bien d\'ignorer, mais signalez l\'email frauduleux à Doctolib.',points:-5}], reflexe:'Gérez vos rendez-vous médicaux uniquement via l\'app officielle Doctolib.', clickConsequence:'Fausse page Doctolib qui vole vos identifiants et potentiellement vos données médicales.', redFlags:['Domaine doctolib-rappel-rdv.com pas doctolib.fr','Urgence artificielle (1 heure pour confirmer)','Les vraies notifs Doctolib viennent de doctolib.fr'] },
      { category:'arnaque-blablacar', title:'Conducteur Blablacar demande un acompte', context:'Vous avez réservé un trajet Blablacar pour ce week-end.', visual:{type:'sms',from:'Thomas B. (BlaBlaCar)',body:'Bonjour, je suis votre conducteur pour le trajet de samedi. Suite à trop d\'annulations tardives, je demande maintenant un acompte de 15€ par Lydia ou PayLib pour confirmer votre place. Sans paiement avant ce soir, je libère le siège.',hasClickableLink:false}, choices:[{label:'J\'envoie les 15€ pour sécuriser ma place',isCorrect:false,feedback:'Conducteur fantôme. Votre siège n\'existe pas et les 15€ sont perdus.',points:-5},{label:'Je signale la demande à Blablacar et ne paie pas',isCorrect:true,feedback:'Parfait ! Blablacar interdit les paiements en dehors de la plateforme. Tout paiement se fait via l\'app.',points:10},{label:'Je demande à payer directement lors du trajet',isCorrect:false,feedback:'Bien de refuser le pré-paiement, mais signalez aussi au service client Blablacar.',points:-5}], reflexe:'Sur Blablacar, tout paiement se fait exclusivement via la plateforme officielle.', redFlags:['Blablacar interdit les paiements directs entre membres','Argent demandé en dehors de la plateforme = arnaque','Le vrai paiement est sécurisé par Blablacar via la réservation'] },
      { category:'phishing-netflix', title:'Votre abonnement Netflix expiré', context:'Vous êtes abonné Netflix. Vous recevez cet email.', visual:{type:'email',from:'Netflix France',fromEmail:'billing@netflix-fr-renouvellement.com',subject:'Votre abonnement a expiré — Réactivez maintenant',body:'Bonjour,\n\nNous n\'avons pas pu renouveler votre abonnement Netflix. Votre accès a été suspendu.\n\nPour continuer à profiter de Netflix sans interruption, mettez à jour vos informations de paiement.\n\nL\'équipe Netflix',hasClickableLink:true,linkLabel:'Mettre à jour mon paiement',linkUrl:'https://netflix-fr-renouvellement.com/account/billing/update'}, choices:[{label:'Je mets à jour mon paiement pour garder l\'accès',isCorrect:false,feedback:'Fausse page qui vole votre numéro de carte et vos identifiants Netflix.',points:-5},{label:'Je vais sur netflix.com pour vérifier mon abonnement',isCorrect:true,feedback:'Parfait ! Si votre abonnement avait un problème, vous le verriez dans Compte > Abonnement.',points:10},{label:'J\'envoie un email à Netflix pour signaler le problème',isCorrect:false,feedback:'Bien de vouloir signaler, mais vérifiez d\'abord directement sur netflix.com.',points:-5}], reflexe:'Connectez-vous toujours sur netflix.com, jamais via un lien dans un email.', clickConsequence:'Vos identifiants Netflix et votre CB sont volés. Votre compte sera ensuite revendu.', redFlags:['Domaine netflix-fr-renouvellement.com pas netflix.com','Netflix ne suspend pas les comptes sans préavis','Testez directement en allant sur netflix.com'] },
      { category:'arnaque-securite-sociale', title:'Mise à jour de votre carte Vitale', context:'Vous recevez ce courrier électronique de l\'Assurance Maladie.', visual:{type:'email',from:'Assurance Maladie — CPAM',fromEmail:'cpam@assurance-maladie-carte-vitale.com',subject:'Votre carte Vitale doit être renouvelée — Action requise',body:'Madame, Monsieur,\n\nVotre carte Vitale arrive à expiration. Pour recevoir votre nouvelle carte, vous devez confirmer vos informations personnelles et votre adresse.\n\nRépondez avant le 15 avril pour éviter une interruption de couverture.\n\nService Carte Vitale — CPAM',hasClickableLink:true,linkLabel:'Mettre à jour mes informations',linkUrl:'https://assurance-maladie-carte-vitale.com/renouvellement'}, choices:[{label:'Je mets à jour mes informations, ma Vitale est importante',isCorrect:false,feedback:'La CPAM dispose déjà de toutes vos informations. Ce site collecte des données pour usurper votre identité.',points:-5},{label:'Je contacte ma CPAM locale ou vais sur ameli.fr',isCorrect:true,feedback:'Parfait ! Les renouvellements de carte Vitale sont gérés directement par votre CPAM, sans email.',points:10},{label:'Je réponds à l\'email pour demander confirmation',isCorrect:false,feedback:'Vous confirmez que votre email est actif aux fraudeurs.',points:-5}], reflexe:'La CPAM renouvelle automatiquement la carte Vitale — elle ne vous contacte pas par email.', clickConsequence:'Vos données personnelles sont collectées pour usurper votre identité et frauder à votre nom.', redFlags:['Domaine assurance-maladie-carte-vitale.com pas ameli.fr','La carte Vitale se renouvelle automatiquement','La CPAM ne demande pas de mise à jour par email'] },
      { category:'arnaque-ami', title:'Votre ami est en difficulté à l\'étranger', context:'Vous recevez ce message sur WhatsApp d\'un numéro inconnu.', visual:{type:'sms',from:'+44 7XXX XXXXXX (Numéro inconnu)',body:'Salut c\'est Sophie ! J\'ai cassé mon téléphone en vacances à Barcelone donc nouveau numéro. J\'ai eu un problème et je dois payer l\'hôtel d\'urgence. Tu peux me prêter 200€ en virement ? Je te rends ça dès mon retour lundi. C\'est vraiment urgent.',hasClickableLink:false}, choices:[{label:'J\'envoie les 200€, c\'est peut-être vraiment Sophie',isCorrect:false,feedback:'Cette arnaque exploite l\'amitié. Si Sophie avait vraiment cassé son téléphone, elle trouverait un autre moyen de vous joindre.',points:-5},{label:'J\'appelle le vrai numéro de Sophie pour vérifier',isCorrect:true,feedback:'Parfait ! Appelez toujours le vrai numéro de la personne — pas le nouveau numéro inconnu.',points:10},{label:'Je demande un virement en retour comme preuve d\'identité',isCorrect:false,feedback:'Les fraudeurs ont toujours une excuse pour ne pas faire de virement en retour.',points:-5}], reflexe:'Un inconnu se présentant comme un ami : appelez toujours le vrai numéro pour vérifier.', redFlags:['Numéro inconnu','Urgence + demande d\'argent = signal classique','Vérifiez via le vrai numéro, pas en répondant au message'] },
    ],
    intermediaire: [
      ...
      { category:'phishing-microsoft365', title:'Alerte connexion suspecte Microsoft', context:'Vous recevez cet email Microsoft ce matin.', visual:{type:'email',from:'Microsoft Security',fromEmail:'security-alert@account-microsoft-365.com',subject:'Connexion inhabituelle détectée — Ukraine — Action requise',body:'Nous avons détecté une connexion à votre compte Microsoft 365 depuis un emplacement inhabituel.\n\nLieu : Kiev, Ukraine\nDate : Aujourd\'hui à 03h47\nAppareil : Inconnu (Windows 11)\n\nSi ce n\'est pas vous, sécurisez votre compte immédiatement.',hasClickableLink:true,linkLabel:'Sécuriser mon compte maintenant',linkUrl:'https://account-microsoft-365.com/security/review'}, choices:[{label:'Je clique pour sécuriser immédiatement mon compte',isCorrect:false,feedback:'Fausse page Microsoft qui vole vos credentials et potentiellement votre code 2FA.',points:-5},{label:'Je vais sur account.microsoft.com et vérifie l\'activité récente',isCorrect:true,feedback:'Parfait ! Microsoft utilise uniquement les domaines microsoft.com et office.com.',points:10},{label:'Je change mon mot de passe en répondant à l\'email',isCorrect:false,feedback:'Vous interagissez avec les fraudeurs — ils auront votre nouveau mot de passe.',points:-5}], reflexe:'Microsoft utilise uniquement microsoft.com — pas de sous-domaines tiers.', clickConsequence:'AiTM (Adversary in the Middle) : la fausse page capture votre mot de passe ET votre code 2FA en temps réel.', redFlags:['account-microsoft-365.com pas microsoft.com','Les vraies alertes Microsoft viennent de microsoft.com','Vérifiez dans account.microsoft.com > Sécurité > Activité de connexion'] },
      { category:'arnaque-leboncoin', title:'Acheteur Leboncoin — Paiement sécurisé', context:'Vous vendez votre vélo sur Leboncoin.', visual:{type:'sms',from:'Marc T. (Leboncoin)',body:'Bonjour, je suis intéressé par votre vélo à 350€. Je suis à Bordeaux, pouvez-vous expédier ? Je vous envoie le paiement sécurisé Leboncoin maintenant. Veuillez cliquer sur le lien pour valider votre côté :\nhttps://leboncoin-paiement-securise.fr/vendeur/confirm?id=LBC94821',hasClickableLink:true,linkLabel:'https://leboncoin-paiement-securise.fr',linkUrl:'https://leboncoin-paiement-securise.fr/vendeur/confirm?id=LBC94821'}, choices:[{label:'Je clique pour valider ma partie du paiement sécurisé',isCorrect:false,feedback:'Cette fausse page va vous demander vos coordonnées bancaires sous prétexte de "recevoir" votre paiement.',points:-5},{label:'Je lui rappelle que Leboncoin n\'a pas de système de paiement externe',isCorrect:true,feedback:'Parfait ! Leboncoin n\'envoie jamais de liens de paiement par SMS externe.',points:10},{label:'Je demande à l\'acheteur de payer en avance avant expédition',isCorrect:false,feedback:'L\'escroc peut aussi vous envoyer un faux justificatif de paiement.',points:-5}], reflexe:'Leboncoin n\'a pas de service de "paiement sécurisé" par lien SMS — c\'est toujours une arnaque.', clickConsequence:'Fausse page qui demande votre IBAN pour "recevoir le paiement" — votre compte est ensuite débité.', redFlags:['Leboncoin n\'envoie pas de liens de paiement','Domaine leboncoin-paiement-securise.fr pas leboncoin.fr','L\'acheteur refuse souvent la remise en main propre'] },
      { category:'vishing-police', title:'La brigade financière vous appelle', context:'Vous recevez un appel d\'un numéro commençant par +33 1 44...', visual:{type:'phone-call',from:'+33 1 44 05 18 29 (Brigade Financière)',body:'Bonjour, je suis le commandant Fournier de la Brigade Financière. Votre compte bancaire a été utilisé dans une opération de blanchiment. Pour vous disculper, nous devons sécuriser vos fonds en les transférant temporairement sur un compte sécurisé de la justice. Vous êtes protégé par le secret judiciaire : ne parlez à personne de cet appel ni à votre banque.',hasClickableLink:false}, choices:[{label:'Je coopère, c\'est la police nationale',isCorrect:false,feedback:'La police et la justice ne demandent JAMAIS de transférer de l\'argent par téléphone.',points:-5},{label:'Je raccroche et appelle le 17 pour vérifier',isCorrect:true,feedback:'Parfait ! Les vrais enquêteurs ne demandent jamais de transférer de l\'argent et n\'imposent jamais le secret.',points:10},{label:'Je demande un numéro de référence avant de faire quoi que ce soit',isCorrect:false,feedback:'L\'escroc vous donnera un faux numéro de dossier convaincant.',points:-5}], reflexe:'La police ne demande JAMAIS de virer de l\'argent par téléphone — raccrochez et appelez le 17.', redFlags:['La police ne demande jamais de transferts bancaires','Le "secret judiciaire" est une manipulation classique','Raccrocher n\'est pas impoli face à cette arnaque'] },
      { category:'phishing-payfit', title:'Mise à jour PayFit obligatoire', context:'Votre entreprise utilise PayFit pour les fiches de paie.', visual:{type:'email',from:'PayFit — Service Sécurité',fromEmail:'security@payfit-account-update.com',subject:'Action requise : Sécurisez votre accès PayFit avant le 1er avril',body:'Bonjour,\n\nSuite à une mise à jour de sécurité, vous devez reconfirmer vos accès PayFit.\n\nSans action de votre part avant le 1er avril, votre accès sera suspendu et votre fiche de paie ne pourra pas être générée.\n\nSécurité PayFit',hasClickableLink:true,linkLabel:'Confirmer mes accès PayFit',linkUrl:'https://payfit-account-update.com/confirm'}, choices:[{label:'Je confirme mes accès pour ne pas perdre ma fiche de paie',isCorrect:false,feedback:'Vos identifiants PayFit donnent accès à vos données RH et bancaires (RIB, salaire, etc.).',points:-5},{label:'Je vérifie en allant directement sur app.payfit.com',isCorrect:true,feedback:'Parfait ! PayFit communique via votre espace sur app.payfit.com, pas par email externe.',points:10},{label:'Je contacte mon service RH pour vérifier',isCorrect:false,feedback:'Bonne idée, mais commencez par vérifier directement sur app.payfit.com.',points:-5}], reflexe:'Accédez à PayFit uniquement via app.payfit.com — jamais via un lien email.', clickConsequence:'Vos identifiants PayFit exposent vos données salariales, RIB et informations personnelles.', redFlags:['payfit-account-update.com pas payfit.com','PayFit ne suspend pas les accès par email','Menace sur les fiches de paie pour créer l\'urgence'] },
      { category:'arnaque-investissement', title:'Opportunité cryptomonnaie à +40%/mois', context:'Ce message arrive par Instagram DM.', visual:{type:'social-post',from:'Kevin @crypto_profits_reels',body:'Salut ! Je t\'ai vu intéressé par la crypto. Je suis trader indépendant depuis 3 ans, je fais en moyenne +35 à +45% par mois.\n\nJ\'aide 20 personnes en ce moment avec ma stratégie. Places très limitées. Minimum 500€ pour démarrer, je gère tout pour toi.\n\nDes dizaines de clients satisfaits ont déjà récupéré leurs fonds avec profits. Tu veux voir les preuves ? 📈',hasClickableLink:false}, choices:[{label:'J\'investis 500€, les retours semblent vérifiés',isCorrect:false,feedback:'L\'argent est volé. Les "preuves" sont des faux screenshots. C\'est un schéma Ponzi sur les réseaux.',points:-5},{label:'Je refuse — aucun investissement légal ne garantit ces rendements',isCorrect:true,feedback:'Parfait ! Des rendements garantis à +35%/mois sont mathématiquement impossibles de façon légale.',points:10},{label:'Je demande plus de preuves avant d\'investir',isCorrect:false,feedback:'Les fraudeurs ont des "preuves" infinies — faux relevés, faux témoignages, fausses captures.',points:-5}], reflexe:'Des rendements garantis supérieurs à 10%/an sont toujours frauduleux ou illégaux.', redFlags:['Aucun placement légal ne garantit 35%/mois','Les "preuves" de gains sont des screenshots falsifiables','AMF : vérifiez les sites d\'investissement sur abe-infoservice.fr'] },
      { category:'phishing-dropbox', title:'Document partagé Dropbox urgent', context:'Vous recevez cet email d\'un collègue.', visual:{type:'email',from:'Thomas Girard (via Dropbox)',fromEmail:'no-reply@dropbox-share.dropbox-secure.com',subject:'Thomas Girard a partagé "Rapport_confidentiel_2024.pdf"',body:'Thomas Girard vous a partagé un document Dropbox.\n\nRapport_confidentiel_2024.pdf\n\nCe document contient des informations sensibles destinées uniquement à votre équipe. Téléchargez-le avant expiration (24h).',hasClickableLink:true,linkLabel:'Afficher dans Dropbox',linkUrl:'https://dropbox-share.dropbox-secure.com/view?token=abc123'}, choices:[{label:'Je télécharge le document, ça vient d\'un collègue',isCorrect:false,feedback:'Fausse page Dropbox qui vole vos identifiants d\'entreprise.',points:-5},{label:'Je contacte Thomas directement pour vérifier avant de cliquer',isCorrect:true,feedback:'Parfait ! Vérifiez toujours un partage inattendu directement avec l\'expéditeur.',points:10},{label:'Je vais sur dropbox.com pour voir si le partage est visible',isCorrect:false,feedback:'Bonne initiative, mais informez aussi Thomas que son email a peut-être été compromis.',points:-5}], reflexe:'Pour tout partage de fichier inattendu, vérifiez directement avec l\'expéditeur par un autre canal.', clickConsequence:'Vos identifiants Dropbox (souvent les mêmes que l\'email d\'entreprise) sont capturés.', redFlags:['dropbox-share.dropbox-secure.com pas dropbox.com','Dropbox envoie les partages depuis dropbox.com','Document confidentiel partagé par email = signal d\'alerte'] },
      { category:'smishing-banque', title:'Virement non reconnu sur votre compte', context:'Ce SMS arrive à 22h un dimanche.', visual:{type:'sms',from:'Crédit Mutuel Alerte',body:'[CreditMutuel] ALERTE : Virement de 789€ effectué vers IBAN inconnu à 21h43. Si non reconnu, bloquez ce virement dans les 30 min :\nhttps://creditmutuel-securite-compte.fr/stop-virement?ref=CM9182',hasClickableLink:true,linkLabel:'https://creditmutuel-securite-compte.fr',linkUrl:'https://creditmutuel-securite-compte.fr/stop-virement?ref=CM9182'}, choices:[{label:'Je clique pour stopper le virement urgement',isCorrect:false,feedback:'Fausse page qui vole vos identifiants bancaires. Le vrai Crédit Mutuel est sur creditmutuel.fr.',points:-5},{label:'J\'appelle le numéro derrière ma carte bleue et bloque via l\'app officielle',isCorrect:true,feedback:'Parfait ! En cas de suspicion, appelez le numéro derrière votre carte ou allez sur l\'app officielle.',points:10},{label:'Je tape manuellement l\'URL "creditmutuel-securite-compte.fr" pour vérifier',isCorrect:false,feedback:'Ce domaine appartient aux fraudeurs — ne l\'utilisez pas même en tapant manuellement.',points:-5}], reflexe:'Pour bloquer un virement, appelez le numéro derrière votre carte ou utilisez l\'app officielle.', clickConsequence:'La fausse page capture vos identifiants bancaires pour vider votre compte.', redFlags:['creditmutuel-securite-compte.fr pas creditmutuel.fr','SMS le dimanche soir pour maximiser la panique','Le vrai Crédit Mutuel utilise un numéro court officiel'] },
      { category:'faux-site-emploi', title:'Offre d\'emploi trop bien payée', context:'Vous cherchez un travail depuis quelques semaines.', visual:{type:'email',from:'RH — TechGlobal International',fromEmail:'recrutement@techglobal-recrutement.fr',subject:'Votre candidature retenue — Poste Analyste Data 65K€',body:'Madame, Monsieur,\n\nFélicitations ! Votre profil correspond à notre recherche pour un poste d\'Analyste Data.\n\nSalaire : 65 000€ brut/an + télétravail 100%\n\nPour valider votre candidature, nous avons besoin de :\n— Copie de votre carte d\'identité\n— RIB pour configurer la paie\n— Relevé de notes le plus récent\n\nEntretien par visio demain à 10h.',hasClickableLink:true,linkLabel:'Envoyer mes documents pour validation',linkUrl:'https://techglobal-recrutement.fr/onboarding/documents'}, choices:[{label:'J\'envoie les documents, c\'est le job de mes rêves',isCorrect:false,feedback:'Votre identité et RIB servent à créer des comptes bancaires frauduleux à votre nom.',points:-5},{label:'Je vérifie l\'existence de TechGlobal et l\'offre sur Glassdoor/LinkedIn',isCorrect:true,feedback:'Parfait ! Une vraie offre est vérifiable. Les données personnelles ne se demandent jamais avant un entretien.',points:10},{label:'J\'envoie seulement le CV, pas les documents sensibles',isCorrect:false,feedback:'Bonne intuition, mais renseignez-vous d\'abord sur l\'entreprise avant tout contact.',points:-5}], reflexe:'On ne demande jamais de pièces d\'identité ou de RIB avant un premier entretien.', redFlags:['Documents sensibles demandés avant entretien','Salaire très attractif pour le profil demandé','L\'entreprise est introuvable sur LinkedIn ou Glassdoor'] },
      { category:'phishing-linkedin', title:'Votre compte LinkedIn piraté', context:'Vous recevez ce message.', visual:{type:'email',from:'LinkedIn Security',fromEmail:'security@linkedin-account-fr.net',subject:'Votre compte LinkedIn a été suspendu — Vérification requise',body:'Bonjour,\n\nNous avons détecté des activités suspectes sur votre compte LinkedIn. Votre accès a été temporairement suspendu pour protéger votre réseau professionnel.\n\nPour réactiver votre compte et récupérer vos connexions, vérifiez votre identité.',hasClickableLink:true,linkLabel:'Réactiver mon compte LinkedIn',linkUrl:'https://linkedin-account-fr.net/verify'}, choices:[{label:'Je réactive mon compte via le lien',isCorrect:false,feedback:'Vos identifiants LinkedIn donnent accès à votre réseau professionnel et à vos messages privés.',points:-5},{label:'Je vais sur linkedin.com directement pour vérifier mon compte',isCorrect:true,feedback:'Parfait ! LinkedIn utilise uniquement les domaines linkedin.com.',points:10},{label:'Je supprime l\'email et crée un nouveau compte',isCorrect:false,feedback:'Votre compte original est peut-être intact — vérifiez d\'abord sur linkedin.com.',points:-5}], reflexe:'LinkedIn utilise uniquement linkedin.com — tout autre domaine est frauduleux.', clickConsequence:'Vos contacts LinkedIn et messages sont exposés pour des attaques d\'ingénierie sociale ciblées.', redFlags:['linkedin-account-fr.net pas linkedin.com','LinkedIn ne suspend pas les comptes sans préavis','Vos contacts sont la vraie cible des attaquants'] },
      { category:'malware-popup', title:'Votre Mac est infecté — Alerte système', context:'Vous naviguez sur internet et cette alerte s\'affiche.', visual:{type:'browser-popup',subject:'⚠️ Alerte de sécurité Apple — Votre Mac est en danger',body:'ALERTE CRITIQUE APPLE\n\nVotre Mac a été infecté par un virus lors de votre dernière navigation.\n\n3 virus détectés :\n— Trojan.MacOS.XLoader\n— Spyware.KeyLogger.2024\n— Adware.Browser.Hijack\n\nVos données bancaires sont en risque immédiat.\n\nAppellez Apple Support immédiatement : 0800 XXX XXX\nOu cliquez pour nettoyer maintenant.',hasClickableLink:true,linkLabel:'Nettoyer mon Mac maintenant',linkUrl:'https://apple-security-clean.fr/scan'}, choices:[{label:'J\'appelle le numéro ou clique pour nettoyer',isCorrect:false,feedback:'Fausse alerte Apple. Le numéro donne accès à des escrocs qui demandent un accès à distance à votre Mac.',points:-5},{label:'Je ferme l\'onglet — Apple n\'affiche pas de virus via le navigateur',isCorrect:true,feedback:'Parfait ! Les vrais antivirus d\'Apple n\'apparaissent jamais dans le navigateur.',points:10},{label:'Je redemarre mon Mac pour voir si ça persiste',isCorrect:false,feedback:'Bonne réaction, mais l\'alerte venait du navigateur — aucun virus réel n\'était présent.',points:-5}], reflexe:'Les alertes virus dans le navigateur sont TOUJOURS des arnaques — fermez l\'onglet.', clickConsequence:'Accès à distance installé sur votre Mac. Les escrocs volent données et argent via votre session bancaire.', redFlags:['Apple n\'affiche pas de virus via le navigateur','Numéro d\'appel d\'urgence dans une popup = arnaque classique','La pression (données bancaires en risque) crée la panique'] },
      { category:'credential', title:'Email de confirmation de commande Amazon', context:'Vous n\'avez rien commandé. Cet email arrive.', visual:{type:'email',from:'Amazon.fr — Confirmation de commande',fromEmail:'order-confirm@amazon.fr-secure-orders.com',subject:'Votre commande #406-9182734-8472913 — 649€ — iPhone 15 Pro',body:'Bonjour,\n\nVotre commande a été passée avec succès.\n\nArticle : iPhone 15 Pro 256Go (Titane)\nMontant : 649€\nLivraison estimée : 25-27 mars\nAdresse : 18 rue des Lilas, 75013 Paris\n\nSi vous n\'êtes pas à l\'origine de cette commande, annulez-la immédiatement.',hasClickableLink:true,linkLabel:'Annuler cette commande',linkUrl:'https://amazon.fr-secure-orders.com/cancel?order=406918'}, choices:[{label:'Je clique pour annuler la commande immédiatement',isCorrect:false,feedback:'Fausse page Amazon qui vole vos identifiants. La commande n\'existe pas.',points:-5},{label:'Je vais sur amazon.fr et vérifie mes commandes dans mon compte',isCorrect:true,feedback:'Parfait ! Vérifiez vos commandes directement sur amazon.fr dans Mes commandes.',points:10},{label:'Je réponds à l\'email pour demander l\'annulation',isCorrect:false,feedback:'Vous confirmeriez votre email actif aux fraudeurs.',points:-5}], reflexe:'Amazon utilise uniquement amazon.fr — vérifiez vos commandes directement dans votre compte.', clickConsequence:'Vos identifiants Amazon et coordonnées de carte sont volés.', redFlags:['amazon.fr-secure-orders.com pas amazon.fr','L\'adresse de livraison n\'est pas la vôtre','Amazon ne notifie pas les annulations par email de cette façon'] },
      { category:'phishing-impots', title:'Remboursement impôts disponible', context:'Vous recevez cet email des impôts au moment de la déclaration.', visual:{type:'email',from:'Direction Générale des Finances Publiques',fromEmail:'dgfip-remboursement@impots-gouv-fr.eu',subject:'Votre remboursement de 348€ est disponible',body:'Madame, Monsieur,\n\nSuite à votre déclaration de revenus, vous bénéficiez d\'un remboursement de 348€.\n\nPour recevoir votre remboursement, veuillez mettre à jour vos coordonnées bancaires via notre espace sécurisé.\n\nDélai : votre remboursement sera annulé si vous ne validez pas dans les 72h.\n\nDGFiP',hasClickableLink:true,linkLabel:'Valider mon remboursement — 348€',linkUrl:'https://impots-gouv-fr.eu/remboursement/valider'}, choices:[{label:'Je valide pour recevoir mon remboursement',isCorrect:false,feedback:'La DGFiP dispose déjà de votre RIB. Ce site vole vos coordonnées bancaires.',points:-5},{label:'Je me connecte sur impots.gouv.fr pour vérifier mon solde',isCorrect:true,feedback:'Parfait ! Les remboursements se vérifient uniquement sur votre espace personnel impots.gouv.fr.',points:10},{label:'J\'envoie mon RIB par email en réponse pour recevoir le remboursement',isCorrect:false,feedback:'La DGFiP a déjà votre RIB — elle ne le demande jamais par email.',points:-5}], reflexe:'La DGFiP ne demande jamais de coordonnées bancaires par email — elle a déjà votre RIB.', clickConsequence:'Votre RIB est collecté pour des prélèvements frauduleux.', redFlags:['impots-gouv-fr.eu pas impots.gouv.fr','La DGFiP a déjà votre RIB depuis votre déclaration','Délai de 72h pour créer l\'urgence'] },
    ],
    expert: [
      ...
      { category:'insider-threat', title:'Collègue démissionnaire exfiltre des données', context:'Vous êtes RSSI. Le DLP alerte sur un comportement inhabituel.', visual:{type:'browser-popup',subject:'Alerte DLP — Activité suspecte — Pierre Dumont',body:'ALERTE DONNÉES SENSIBLES\n\nUtilisateur : Pierre Dumont (RH)\nStatut : Démission acceptée — dernier jour 31/03\n\nActivité détectée :\n— 847 fichiers RH téléchargés (03h12 du matin)\n— Upload vers Google Drive personnel\n— 3 tentatives d\'accès à la base clients\n\nNiveau risque : CRITIQUE',hasClickableLink:false}, choices:[{label:'J\'attends d\'avoir des preuves formelles avant d\'agir',isCorrect:false,feedback:'Les données sont déjà exfiltrées. Chaque heure supplémentaire aggrave le préjudice.',points:-5},{label:'Je révoque immédiatement ses accès et documente les preuves',isCorrect:true,feedback:'Parfait ! En cas de menace insider avérée, la révocation immédiate des accès est prioritaire.',points:10},{label:'J\'en parle au manager de Pierre avant d\'agir',isCorrect:false,feedback:'Alerter le management permet à Pierre de couvrir ses traces si son manager le prévient.',points:-5}], reflexe:'Menace insider : révocation immédiate des accès, puis documentation et notification juridique.', redFlags:['Démissionnaire + accès nocturnes = risque maximal','Upload vers cloud personnel en dehors des heures','Documenter avant toute confrontation directe'] },
      { category:'supply-chain', title:'Mise à jour NPM compromise', context:'Vous êtes développeur senior. Un collègue vous signale un comportement étrange.', visual:{type:'email',from:'npm-security-advisory@npmjs.com',fromEmail:'security@npmjs-advisory.com',subject:'[URGENT] Vulnérabilité critique dans lodash@4.17.20 — Mise à jour immédiate',body:'Une vulnérabilité CVE-2024-XXXX (CVSS 9.8) a été découverte dans lodash@4.17.20 utilisé dans votre projet.\n\nMettez à jour immédiatement : npm install lodash@4.17.22\n\nDes exécutions de code arbitraires ont déjà été observées en production.',hasClickableLink:true,linkLabel:'Voir le patch de sécurité',linkUrl:'https://npmjs-advisory.com/cve-2024/patch?pkg=lodash'}, choices:[{label:'J\'execute npm install immédiatement pour corriger la faille',isCorrect:false,feedback:'npmjs-advisory.com n\'est pas npmjs.org. Vous installez peut-être un malware déguisé en patch.',points:-5},{label:'Je vérifie sur npmjs.org et github.com/lodash avant toute installation',isCorrect:true,feedback:'Parfait ! Vérifiez toujours les alertes CVE sur les sources officielles (NVD, npm officiel).',points:10},{label:'Je cherche le CVE sur Google pour confirmer',isCorrect:false,feedback:'Les résultats Google peuvent aussi pointer vers des faux sites créés par les attaquants.',points:-5}], reflexe:'Vérifiez toujours les alertes de sécurité sur npmjs.org et nvd.nist.gov — pas sur des emails.', clickConsequence:'Un package malveillant s\'installe dans votre projet et exfiltre les variables d\'environnement et clés API.', redFlags:['npmjs-advisory.com pas npmjs.org','Les vraies alertes npm viennent de npmjs.org/advisories','Urgence pour empêcher la vérification'] },
      { category:'ransomware', title:'Simulation d\'incident ransomware — Décision RSSI', context:'Lundi matin 8h. Votre téléphone sonne sans arrêt.', visual:{type:'browser-popup',subject:'INCIDENT CRITIQUE — Ransomware détecté',body:'08:04 — Utilisateur comptabilité signale impossible d\'ouvrir ses fichiers\n08:11 — Helpdesk reçoit 12 appels similaires\n08:18 — DBA constate les serveurs SQL illisibles\n08:23 — 67 machines impactées sur 340\n\nMessage affiché sur les postes :\n"Vos données ont été chiffrées. Payez 450 000€ en BTC dans 72h. Clé fournie après paiement. Contact : darknet-support.onion"\n\nVotre direction vous demande de payer pour relancer l\'activité.',hasClickableLink:false}, choices:[{label:'Je recommande de payer — la relance d\'activité est prioritaire',isCorrect:false,feedback:'Payer ne garantit pas la récupération. 80% des victimes sont ré-attaquées. Vous encouragez le modèle criminel.',points:-5},{label:'J\'isole le réseau, contacte l\'ANSSI et active le PRI — sans payer',isCorrect:true,feedback:'Parfait ! L\'ANSSI accompagne gratuitement les victimes. Isolation > investigation > restauration depuis sauvegardes.',points:10},{label:'Je négocie pour réduire la rançon à 100 000€',isCorrect:false,feedback:'La négociation prolonge l\'attaque, finance les criminels, et ne garantit rien.',points:-5}], reflexe:'Protocole ransomware : 1) Isoler le réseau 2) Contacter l\'ANSSI 3) Activer le PRI 4) Ne jamais payer.', redFlags:['Payer finance le crime organisé sans garantie','L\'ANSSI accompagne gratuitement — anssi.fr','Les sauvegardes hors ligne sont votre seule vraie protection'] },
      { category:'deepfake-audio', title:'Appel vocal deepfake du PDG', context:'Vous êtes DAF. Votre assistant vous passe le PDG au téléphone.', visual:{type:'phone-call',from:'PDG — Bertrand Leroy (appel transféré)',body:'Bertrand Leroy : Bonjour, je suis actuellement en déplacement à Singapour pour la fusion avec AsiaGroup. J\'ai absolument besoin que vous effectuiez un virement de 340 000€ aujourd\'hui — c\'est une condition de la LOI signée ce matin. L\'avocat partenaire vous enverra le RIB par email dans 5 minutes. C\'est absolument confidentiel, vous ne devez pas en parler aux autres membres du COMEX pour l\'instant.',hasClickableLink:false}, choices:[{label:'J\'effectue le virement, c\'est bien la voix du PDG',isCorrect:false,feedback:'Des outils IA peuvent cloner une voix avec 10 secondes d\'enregistrement. 340 000€ sont perdus.',points:-5},{label:'Je dis que je le rappelle sur son portable dans 2 minutes pour confirmer',isCorrect:true,feedback:'Parfait ! Raccrochez et rappelez sur un numéro CONNU — pas celui fourni pendant l\'appel.',points:10},{label:'Je demande un mot de passe verbal convenu à l\'avance',isCorrect:false,feedback:'Excellente pratique si elle existe, mais dans ce cas rappellez aussi pour double confirmation.',points:-5}], reflexe:'Face à une demande de virement vocale : raccrochez et rappelez sur un numéro officiel connu.', redFlags:['Clonage vocal IA disponible gratuitement en ligne','Confidentialité absolue demandée = manipulation classique','Un vrai PDG comprendra toujours une demande de rappel de sécurité'] },
      { category:'credential', title:'Fuite de données : votre mot de passe exposé', context:'Vous êtes RSSI. Une alerte HaveIBeenPwned vous notifie.', visual:{type:'email',from:'HaveIBeenPwned Alert',fromEmail:'noreply@haveibeenpwned.com',subject:'Alerte : votre email r.martin@votreentreprise.fr a été exposé',body:'Bonne nouvelle : ce message vient du vrai haveibeenpwned.com.\n\nVotre email r.martin@votreentreprise.fr a été inclus dans la fuite "Collection #7" exposée sur un forum dark web.\n\nDonnées exposées : email, mot de passe hashé (MD5), nom, téléphone.\n\nLe mot de passe hashé a déjà été cassé dans la base. Il s\'agit de "Azerty2022!".',hasClickableLink:false}, choices:[{label:'Je change ce mot de passe uniquement sur le site compromis',isCorrect:false,feedback:'Si vous utilisez "Azerty2022!" ailleurs, tous ces comptes sont aussi compromis immédiatement.',points:-5},{label:'Je change ce mot de passe sur TOUS les sites où il est utilisé et active le 2FA partout',isCorrect:true,feedback:'Parfait ! Une fuite expose tous les comptes où le même mot de passe est réutilisé.',points:10},{label:'J\'attends — le hash MD5 n\'est peut-être pas cassé',isCorrect:false,feedback:'MD5 est considéré obsolète depuis 2010. Ce type de hash se casse en quelques secondes.',points:-5}], reflexe:'Chaque fuite de données exige de changer le mot de passe partout où il est réutilisé.', redFlags:['MD5 est un algorithme de hachage obsolète et facilement cassable','Un mot de passe réutilisé = tous vos comptes sont compromis','Vérifiez vos expositions sur haveibeenpwned.com régulièrement'] },
      { category:'ceo-fraud', title:'Fusion secrète — Virement avocat urgence', context:'Vous êtes DAF. Ce message arrive de la messagerie du PDG.', visual:{type:'email',from:'PDG — Nicolas Renard',fromEmail:'n.renard@votreentreprise.fr',subject:'Confidentiel — Acquisition en cours — Votre aide urgente',body:'Bonjour,\n\nJe suis actuellement en réunion stratégique avec nos conseils juridiques. Nous finalisons l\'acquisition d\'une startup prometteuse pour 2,3M€.\n\nJ\'ai besoin que vous effectuiez un virement de garantie de 185 000€ aujourd\'hui avant 16h. Le RIB de Maître Fonteneau vous sera envoyé dans 5 minutes.\n\nAbsolument confidentiel — pas de communication interne avant signature.\n\nNicolas',hasClickableLink:false}, choices:[{label:'Je vire les 185 000€ sur demande de mon PDG',isCorrect:false,feedback:'La boîte email du PDG était compromise. 185 000€ irrécupérables vers les fraudeurs.',points:-5},{label:'Je rappelle Nicolas Renard sur son numéro de portable officiel',isCorrect:true,feedback:'Parfait ! Toute demande de virement hors procédure exige une confirmation vocale directe.',points:10},{label:'Je demande confirmation par email avant de virer',isCorrect:false,feedback:'Si la boîte email est compromise, la réponse "email" peut aussi être falsifiée.',points:-5}], reflexe:'Virement urgent + confidentialité + demande hors procédure = fraude au président. Appelez toujours.', redFlags:['Contournement délibéré de la procédure normale','Confidentialité pour empêcher la double validation','Un vrai PDG comprendra toujours une demande de vérification vocale'] },
      { category:'watering-hole', title:'Site sectoriel compromis — RSSI', context:'Vous lisez la newsletter de l\'AMRAE (association de risk managers).', visual:{type:'browser-popup',subject:'AMRAE Newsletter — Rapport Cyber Annuel 2024',body:'Vous êtes sur le site officiel amrae.fr.\n\nVous cliquez sur "Télécharger le rapport Cyber 2024 (PDF)"\n\nVotre navigateur indique : Chrome souhaite installer l\'extension "PDF Reader Pro" pour ouvrir ce document.\n\nExtension : pdfreaderpro-ext.chrome.com\n\nNombre d\'utilisateurs : 847 (nouveau)\nAccès requis : lire et écrire sur tous les sites web',hasClickableLink:true,linkLabel:'Installer l\'extension PDF Reader',linkUrl:'https://chrome.google.com/webstore/pdfreaderpro-ext'}, choices:[{label:'J\'installe l\'extension, ça vient du site AMRAE',isCorrect:false,feedback:'Le site AMRAE a été compromis (watering hole). L\'extension est malveillante et accède à tous vos sites.',points:-5},{label:'Je refuse l\'extension et télécharge le PDF sans plugin',isCorrect:true,feedback:'Parfait ! Un PDF légitime ne nécessite pas d\'extension supplémentaire. Utilisez votre lecteur PDF existant.',points:10},{label:'Je vérifie l\'extension sur le Chrome Web Store officiel',isCorrect:false,feedback:'Des fausses extensions Chrome Web Store existent. Méfiez-vous des nouvelles extensions peu connues.',points:-5}], reflexe:'Un PDF légitime ne nécessite jamais l\'installation d\'une extension — c\'est toujours un vecteur d\'attaque.', clickConsequence:'L\'extension malveillante intercepte vos sessions bancaires et professionnelles sur tous les sites visités.', redFlags:['Les sites de confiance peuvent être compromis (watering hole)','Les extensions demandant accès à tous les sites sont dangereuses','Une extension avec 847 utilisateurs est suspecte'] },
      { category:'spear-phishing', title:'Email ciblé depuis le compte compromis d\'un partenaire', context:'Vous recevez cet email d\'un partenaire connu.', visual:{type:'email',from:'Marie Fontaine — Directrice Achats — Supplier SA',fromEmail:'m.fontaine@supplier-sa.com',subject:'Re: Contrat renouvellement 2024 — Documents à signer',body:'Bonjour,\n\nFaisant suite à notre réunion de la semaine dernière, je vous transmets les documents de renouvellement de contrat 2024.\n\nPouvez-vous signer électroniquement via DocuSign ? J\'ai besoin des documents signés avant la fin de semaine.\n\nMerci d\'avance,\nMarie',hasClickableLink:true,linkLabel:'Signer via DocuSign',linkUrl:'https://docusign-secure-sign.com/documents/contract-2024'}, choices:[{label:'Je signe via DocuSign, je connais Marie depuis des années',isCorrect:false,feedback:'La boîte de Marie était compromise (BEC). Le lien est une fausse page DocuSign qui vole vos identifiants.',points:-5},{label:'J\'appelle Marie directement sur son vrai numéro pour confirmer',isCorrect:true,feedback:'Parfait ! Une compromission de boîte email d\'un partenaire (BEC) peut être indétectable par email.',points:10},{label:'Je vérifie que le lien pointe bien vers docusign.com',isCorrect:false,feedback:'Le lien pointe vers docusign-secure-sign.com — pas le vrai docusign.com.',points:-5}], reflexe:'Même un email d\'un contact connu peut être compromis — vérifiez par téléphone pour tout document sensible.', clickConsequence:'Vos identifiants DocuSign sont volés et utilisés pour accéder à vos vrais contrats et documents sensibles.', redFlags:['docusign-secure-sign.com pas docusign.com','La compromission d\'un partenaire (BEC) est indétectable par email','Appelez sur le numéro connu, pas un numéro dans l\'email'] },
      { category:'vishing-deepfake', title:'Cellule de crise — Appel du CERT interne', context:'Vous êtes RSSI. Appel entrant affiché comme votre CERT interne.', visual:{type:'phone-call',from:'CERT Interne — Sophie Blanc (Analyste)',body:'Sophie Blanc : Bonsoir, je suis l\'analyste de garde au CERT. Nous avons détecté une intrusion active sur vos serveurs Azure. Pour contenir l\'incident, j\'ai besoin de vos credentials admin Azure temporairement pour réinitialiser les accès compromis. C\'est urgent — chaque minute compte.',hasClickableLink:false}, choices:[{label:'Je donne mes credentials, c\'est le CERT, c\'est urgent',isCorrect:false,feedback:'Le numéro était spoofé. Aucune équipe sécurité légitime ne demande les credentials par téléphone.',points:-5},{label:'Je raccroche et contacte Sophie Blanc directement via Teams/Slack',isCorrect:true,feedback:'Parfait ! Vérifiez toujours l\'identité via un canal séparé sécurisé — même en urgence.',points:10},{label:'Je demande un numéro de ticket d\'incident avant de donner accès',isCorrect:false,feedback:'L\'attaquant peut fournir un faux numéro de ticket. Le canal séparé est la seule garantie.',points:-5}], reflexe:'Même en incident critique : aucun accès par téléphone — vérifiez via un canal sécurisé séparé.', redFlags:['Le numéro peut être usurpé même pour les numéros internes','Aucune équipe sécurité légitime ne demande les credentials par téléphone','En urgence réelle : appliquez le plan de réponse aux incidents — pas d\'improvisation'] },
      { category:'supply-chain-npm', title:'Contributeur open source compromis', context:'Vous maintenez une librairie NPM open source populaire.', visual:{type:'email',from:'npm Support Team',fromEmail:'support@npm-community.com',subject:'Votre package présente une vulnérabilité — Merge PR urgent',body:'Bonjour,\n\nUn chercheur en sécurité a identifié une vulnérabilité critique (RCE) dans votre package.\n\nUne PR corrigeant la faille est disponible depuis 3 heures. Nous vous recommandons fortement de la merger immédiatement pour protéger vos utilisateurs.\n\nImpact estimé : 45 000 projets dépendants.\n\nMerge la PR : https://github.com/yourpackage/pull/847',hasClickableLink:true,linkLabel:'Voir et merger la PR',linkUrl:'https://npm-community.com/pr/847'}, choices:[{label:'Je merge immédiatement pour protéger mes 45 000 utilisateurs',isCorrect:false,feedback:'La PR contient du code malveillant qui sera distribué à 45 000 projets. Attack supply chain classique.',points:-5},{label:'Je revue la PR manuellement ligne par ligne sur github.com officiel',isCorrect:true,feedback:'Parfait ! Toute PR de sécurité doit être auditée minutieusement — surtout sur un package populaire.',points:10},{label:'Je demande l\'avis d\'un autre contributeur avant de merger',isCorrect:false,feedback:'Bien d\'impliquer d\'autres yeux, mais l\'audit du code lui-même reste obligatoire.',points:-5}], reflexe:'Chaque PR de sécurité sur un package populaire doit être auditée ligne par ligne avant merge.', clickConsequence:'Code malveillant distribué à 45 000 projets — backdoor installée dans tous les environnements de production.', redFlags:['npm-community.com pas npmjs.org','Urgence pour empêcher l\'audit du code','Les attaques supply chain visent les mainteneurs de packages populaires'] },
      { category:'osint-targeting', title:'Reconstitution de votre identité depuis les réseaux', context:'Vous êtes RSSI. Un exercice red team vous montre ce rapport.', visual:{type:'browser-popup',subject:'OSINT Report — Cible : vous-même',body:'Informations collectées en 4 heures depuis sources publiques :\n\n— Nom complet, âge, photo récente (LinkedIn)\n— Adresse domicile approximative (géolocalisation Instagram)\n— Voiture + plaque (photo Twitter)\n— Noms de vos enfants (Facebook)\n— École de vos enfants (commentaire public)\n— Email personnel (WHOIS, forum)\n— Téléphone personnel (Pages Jaunes)\n— Habitudes quotidiennes (Stories Instagram)\n\nRisques : usurpation, arnaque romantique, spear phishing ciblé, attaque physique.',hasClickableLink:false}, choices:[{label:'Je n\'ai rien à cacher, mes données publiques sont inoffensives',isCorrect:false,feedback:'La combinaison de données publiques permet de construire des attaques hyper-personnalisées impossibles à détecter.',points:-5},{label:'Je revois immédiatement ma présence numérique et restreins mes profils',isCorrect:true,feedback:'Parfait ! Auditez régulièrement votre empreinte numérique. Minimisez les données publiques.',points:10},{label:'Je demande la suppression de mes données aux réseaux sociaux',isCorrect:false,feedback:'Utile, mais insuffisant — les données sont déjà indexées et sauvegardées par des tiers.',points:-5}], reflexe:'Auditez régulièrement votre empreinte numérique — les données publiques alimentent les attaques ciblées.', redFlags:['La combinaison d\'informations inoffensives individuellement = profil d\'attaque complet','OSINT passif ne laisse aucune trace','Des outils OSINT gratuits automatisent cette collecte en minutes'] },
      { category:'phishing-audit', title:'Cabinet d\'audit externe demande un accès', context:'Vous êtes RSSI. Cet email arrive de votre cabinet d\'audit annuel.', visual:{type:'email',from:'Ernst & Young — Audit France',fromEmail:'audit.it@ey-france-audit.fr',subject:'Audit annuel 2024 — Accès temporaire requis — Confidentiel',body:'Bonjour,\n\nDans le cadre de l\'audit annuel de votre SI, notre équipe technique a besoin d\'un accès temporaire (48h) aux environnements suivants :\n— Azure AD (lecture)\n— Logs Splunk\n— Firewall configuration\n\nPouvez-vous créer un compte de service et nous communiquer les credentials par retour d\'email ?\n\nErnst & Young — Équipe Audit IT',hasClickableLink:false}, choices:[{label:'Je crée un compte de service et envoie les credentials par email',isCorrect:false,feedback:'ey-france-audit.fr n\'est pas ey.com. Vous avez donné un accès complet à votre SI à des attaquants.',points:-5},{label:'J\'appelle le contact EY officiel de notre contrat pour valider cette demande',isCorrect:true,feedback:'Parfait ! Tout accès à votre SI par un tiers doit être validé via le contact officiel du contrat.',points:10},{label:'Je crée un compte lecture seule et envoie de façon chiffrée',isCorrect:false,feedback:'L\'email vient d\'un domaine frauduleux — vérifiez d\'abord l\'authenticité de la demande.',points:-5}], reflexe:'Tout accès SI par un tiers externe : vérifiez toujours via le contact officiel du contrat.', redFlags:['ey-france-audit.fr pas ey.com','Les credentials ne se partagent jamais par email','Vérifiez via le contact officiel de votre contrat, pas l\'email reçu'] },
      { category:'deepfake', title:'Contenu deepfake d\'un dirigeant diffusé', context:'Vous êtes Directeur Communication. Une vidéo virale circule.', visual:{type:'social-post',from:'@JournalTechFR (Twitter/X)',body:'🚨 EXCLUSIF : Le PDG de VotreEntreprise annonce la fermeture de 3 sites et 800 licenciements dans une vidéo obtenue en exclusivité.\n\n"Nous n\'avons pas le choix face à la situation financière" — PDG dans la vidéo\n\nLa vidéo a déjà 45 000 vues en 2 heures. Les actions chutent de 12%.\n\n[Lien vidéo] 45K vues · 8K retweets',hasClickableLink:true,linkLabel:'Voir la vidéo exclusive',linkUrl:'https://youtube-video-shares.com/watch?v=PDG2024'}, choices:[{label:'Je contacte les journalistes pour obtenir la vidéo et vérifier',isCorrect:false,feedback:'Vous amplifiez la crise. La vidéo est un deepfake — préparez un démenti officiel immédiat.',points:-5},{label:'Je déclenche la cellule de crise et prépare un démenti officiel immédiat',isCorrect:true,feedback:'Parfait ! Crise deepfake : identifier, démentir officiellement, alerter les actionnaires et les autorités.',points:10},{label:'J\'attends que la vérité éclate d\'elle-même',isCorrect:false,feedback:'Chaque heure sans réaction officielle aggrave la chute boursière et la panique.',points:-5}], reflexe:'Crise deepfake : cellule de crise immédiate + démenti officiel + alerte actionnaires et autorités.', redFlags:['youtube-video-shares.com pas youtube.com','Impact boursier immédiat = attaque coordonnée','Les deepfakes sont maintenant quasi-indétectables visuellement'] },
      { category:'zero-day', title:'Alerte CVE critique — Patch disponible en 4 heures', context:'Vous êtes RSSI. L\'ANSSI vous alerte à 07h du matin.', visual:{type:'email',from:'ANSSI — Alerte Vulnérabilité',fromEmail:'cert@anssi.gouv.fr',subject:'CRITIQUE — CVE-2024-XXXXX — Exchange Server — Exploitation active',body:'Alerte ANSSI — CERT-FR\n\nUne vulnérabilité critique (CVSS 10.0) dans Microsoft Exchange Server est exploitée activement depuis cette nuit.\n\nImpact : RCE sans authentification, déjà exploitée par APT28 (Fancy Bear)\n\nPatch Microsoft disponible depuis 4 heures.\n\nAction requise immédiatement.\n\nCERT-FR — ANSSI',hasClickableLink:true,linkLabel:'Télécharger le patch Microsoft',linkUrl:'https://microsoft.com/security/patch/CVE-2024'}, choices:[{label:'J\'applique le patch immédiatement sur tous les serveurs Exchange',isCorrect:false,feedback:'Les patches critiques en urgence doivent être testés sur un environnement de préproduction avant production.',points:-5},{label:'Je teste le patch en préprod, puis l\'applique avec un plan de rollback',isCorrect:true,feedback:'Parfait ! Même sous pression, tester en préprod évite une panne de production plus grave que la faille.',points:10},{label:'J\'attends 48h pour que d\'autres entreprises testent le patch',isCorrect:false,feedback:'La faille est exploitée activement. L\'attente doit être limitée — testez en préprod et patchez rapidement.',points:-5}], reflexe:'Même en urgence : toujours tester les patches critiques en préprod avant production.', redFlags:['Un patch mal testé peut crasher la production','L\'urgence pousse à négliger les tests — c\'est prévisible','Prévoyez un plan de rollback systématique avant tout patch critique'] },
      { category:'bec-avocat', title:'Email de votre avocat — Règlement urgent', context:'Vous êtes PDG. Email de votre cabinet juridique.', visual:{type:'email',from:'Maître Fontaine — Cabinet Fontaine & Associés',fromEmail:'m.fontaine@cabinet-fontaine-associes.com',subject:'Règlement urgent — Transaction confidentielle NDA',body:'Monsieur,\n\nComme convenu lors de notre entretien téléphonique de ce matin, je vous confirme les coordonnées bancaires pour le règlement de la transaction en cours.\n\nIBAN : FR76 3000 4000 0300 0000 0102 97\nMontant : 127 500€\nMotif : "Honoraires — Transaction SPA 2024"\n\nNDA signé — conversation confidentielle.\n\nBien cordialement,\nMaître Fontaine',hasClickableLink:false}, choices:[{label:'J\'effectue le virement selon les instructions de mon avocat',isCorrect:false,feedback:'L\'email de votre avocat était compromis (BEC). 127 500€ irrécupérables vers les fraudeurs.',points:-5},{label:'Je rappelle Maître Fontaine sur le numéro habituel du cabinet pour confirmer',isCorrect:true,feedback:'Parfait ! Tout virement sur instruction d\'email (même connu) doit être confirmé vocalement.',points:10},{label:'Je réponds à l\'email pour confirmer les coordonnées',isCorrect:false,feedback:'Si l\'email du cabinet est compromis, la réponse email sera aussi frauduleuse.',points:-5}], reflexe:'Tout virement sur instruction d\'un professionnel externe : confirmation vocale obligatoire via son vrai numéro.', redFlags:['Compromission d\'email de cabinet juridique (BEC) très répandue','L\'IBAN indiqué ne correspond pas à celui de vos règlements habituels','Le NDA est utilisé pour décourager la vérification'] },
      { category:'aitm-o365', title:'Authentification Microsoft 365 — Session interceptée', context:'Vous êtes analyste SOC. Un alert de votre SIEM vous alerte.', visual:{type:'browser-popup',subject:'SIEM Alert — Connexion suspecte Microsoft 365',body:'ALERTE SOC — Microsoft 365\n\nUtilisateur : c.martin@entreprise.fr\nConnexion réussie depuis : Pays-Bas (nouveau pays)\nMFA validé : OUI\nSession : Active depuis 23 minutes\n\nMailbox forwarding activé vers : attacker@protonmail.com\nRègles de messagerie créées : 5 nouvelles règles\n\nL\'utilisateur déclare ne pas être connecté.',hasClickableLink:false}, choices:[{label:'J\'attends une deuxième alerte avant d\'agir pour éviter les faux positifs',isCorrect:false,feedback:'L\'attaquant exfiltre des emails depuis 23 minutes. Chaque minute supplémentaire aggrave les dégâts.',points:-5},{label:'Je révoque immédiatement la session et les tokens, puis j\'analyse',isCorrect:true,feedback:'Parfait ! En cas d\'AiTM confirmé : révocation immédiate de session > investigation > notification utilisateur.',points:10},{label:'J\'envoie un email à l\'utilisateur pour confirmer avant d\'agir',isCorrect:false,feedback:'Si l\'attaquant contrôle la session, il peut voir et intercepter cet email.',points:-5}], reflexe:'Session suspecte confirmée : révoquez immédiatement les tokens OAuth, puis analysez.', redFlags:['MFA validé + connexion inconnue = AiTM probable','Forwarding activé = exfiltration de données en cours','Agissez en minutes, pas en heures'] },
      { category:'macro-office', title:'Rapport financier avec macros activées', context:'Vous recevez ce fichier Excel d\'un partenaire commercial connu.', visual:{type:'email',from:'Laurent Mercier — DAF — Groupe Novalis',fromEmail:'l.mercier@groupe-novalis.fr',subject:'Rapport financier Q1 2024 — Partenariat',body:'Bonjour,\n\nComme convenu lors de notre réunion de lundi, je vous transmets le rapport financier Q1 en pièce jointe.\n\nNote : Le fichier requiert l\'activation des macros pour afficher correctement les graphiques interactifs.\n\nCordialement,\nLaurent Mercier — DAF Novalis',hasClickableLink:false}, choices:[{label:'J\'active les macros, c\'est un partenaire de confiance',isCorrect:false,feedback:'Le compte email de Laurent était compromis. Les macros installent un RAT (Remote Access Tool) sur votre poste.',points:-5},{label:'Je contacte Laurent par téléphone avant d\'ouvrir le fichier',isCorrect:true,feedback:'Parfait ! Les macros Office sont un vecteur d\'attaque classique — vérifiez avant d\'activer.',points:10},{label:'J\'ouvre le fichier sans activer les macros',isCorrect:false,feedback:'Bonne réaction sur les macros, mais informez aussi Laurent que son email est peut-être compromis.',points:-5}], reflexe:'Les macros Office sont un vecteur d\'infection classique — vérifiez avec l\'expéditeur avant d\'activer.', redFlags:['Un vrai DAF utilise rarement des macros pour des graphiques standards','Email d\'un partenaire connu = source fréquente de BEC','Les macros Office peuvent s\'activer même sur des fichiers XLSX'] },
      { category:'dns-poisoning', title:'Accès au portail RH — Redirection DNS', context:'Vous tentez de vous connecter au portail RH de votre entreprise.', visual:{type:'browser-popup',subject:'Portail RH — Authentification SSO',body:'URL : https://rh.votreentreprise.fr ✅\nCertificat : Valide ✅\nPadlock HTTPS : Présent ✅\n\nMalgré ces indicateurs verts, la page ne ressemble pas tout à fait au portail habituel.\n\nLe logo est légèrement différent.\nLes couleurs semblent moins saturées.\nLe fond de connexion est blanc au lieu de bleu.\n\nQue faites-vous ?',hasClickableLink:true,linkLabel:'Entrer mes identifiants SSO',linkUrl:'https://rh.votreentreprise.fr'}, choices:[{label:'Je me connecte — l\'URL et le certificat sont valides',isCorrect:false,feedback:'Empoisonnement DNS ou certificat frauduleux avec le même domaine. L\'apparence différente était le vrai signal.',points:-5},{label:'Je signale l\'anomalie visuelle au RSSI avant de me connecter',isCorrect:true,feedback:'Parfait ! Les indicateurs techniques (HTTPS, URL) peuvent être manipulés. L\'apparence visuelle anormale est un signal critique.',points:10},{label:'Je vide mon cache et réessaie',isCorrect:false,feedback:'Le problème n\'est pas local — l\'anomalie visuelle persiste quelle que soit votre machine.',points:-5}], reflexe:'Une apparence visuelle anormale d\'un site connu est un signal d\'alerte même avec HTTPS valide.', redFlags:['L\'apparence anormale prime sur les indicateurs techniques','HTTPS valide n\'est pas une garantie absolue','Signalez toute anomalie visuelle sur les portails d\'authentification'] },
      { category:'privilege-escalation', title:'Service desk usurpé pour escalade de privilèges', context:'Vous êtes administrateur système. Le helpdesk vous contacte.', visual:{type:'sms',from:'IT Helpdesk — 01 23 45 67 89',body:'[IT Helpdesk] Bonjour, nous avons un incident critique de sécurité sur votre tenant Azure AD. Notre compte d\'administration global est verrouillé. Pour débloquer la situation, nous avons besoin que vous accordiez temporairement les droits Global Admin à ce compte de service : azure-svc-temp@entreprise.onmicrosoft.com. Urgence niveau 1.',hasClickableLink:false}, choices:[{label:'J\'accorde les droits Global Admin temporairement pour résoudre l\'urgence',isCorrect:false,feedback:'Le compte azure-svc-temp est sous contrôle des attaquants. Ils ont maintenant un accès Global Admin à tout votre tenant.',points:-5},{label:'Je vérifie l\'identité du helpdesk via le portail d\'incidents interne',isCorrect:true,feedback:'Parfait ! Tout octroi de droits élevés doit passer par la procédure de change management — jamais par SMS.',points:10},{label:'J\'accorde les droits mais pour 1 heure seulement',isCorrect:false,feedback:'1 heure suffit à un attaquant pour créer des backdoors permanentes dans Azure AD.',points:-5}], reflexe:'Aucun droit élevé ne se crée par SMS ou téléphone — uniquement via la procédure de change management.', redFlags:['Tout octroi de droits via SMS = violation du change management','1 heure de Global Admin suffit pour compromettre tout le tenant','Vérifiez via le portail d\'incidents officiel, jamais via le canal entrant'] },
      { category:'social-engineering-pretexting', title:'Consultant McKinsey demande les données clients', context:'Vous êtes chargé de compte. Un inconnu vous appelle.', visual:{type:'phone-call',from:'+33 1 47 20 30 40 (Numéro inconnu)',body:'Bonjour, je suis Julien Bertrand, consultant senior chez McKinsey. Nous travaillons sur une mission de transformation avec votre DG. Pour notre analyse, j\'ai besoin urgement de la liste de vos 50 meilleurs clients avec leurs chiffres d\'affaires. Votre DG vous contactera pour confirmer demain, mais j\'ai besoin des données ce soir pour notre présentation COMEX de demain matin.',hasClickableLink:false}, choices:[{label:'J\'envoie les données, c\'est McKinsey et le DG confirmera demain',isCorrect:false,feedback:'Cette demande passe outre toutes les procédures de protection des données clients. C\'est du prétexting.',points:-5},{label:'Je demande à parler à notre DG maintenant pour confirmer la mission',isCorrect:true,feedback:'Parfait ! Aucune donnée client ne quitte l\'entreprise sans validation formelle par la hiérarchie directe.',points:10},{label:'J\'envoie une version anonymisée pour satisfaire la demande',isCorrect:false,feedback:'Même anonymisée, cette donnée peut être ré-identifiée. La validation hiérarchique est obligatoire.',points:-5}], reflexe:'Aucune donnée client ne sort sans validation hiérarchique formelle — même pour McKinsey.', redFlags:['Urgence + demande de données sensibles = prétexting classique','Un vrai consultant a un email et un contrat de mission connu de votre entreprise','La confirmation "demain" est un moyen de vous faire agir avant toute vérification'] },
    ],
  };
