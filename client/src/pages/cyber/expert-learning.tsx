                              ...
                              <div className="space-y-1.5">
                                ...
                                <Button 
                                  ...
                                  onClick={() => {
                                    // Utiliser un léger délai pour s'assurer que l'état est mis à jour
                                    setTimeout(() => {
                                      const tmpMessage = "Propose-moi un scénario de décision en cybersécurité";
                                ...
                                <Button 
                                  ...
                                  onClick={() => {
                                    // Utiliser un léger délai pour s'assurer que l'état est mis à jour
                                    setTimeout(() => {
                                      const tmpMessage = "Évalue mes connaissances avec un quiz interactif sur la cybersécurité";
