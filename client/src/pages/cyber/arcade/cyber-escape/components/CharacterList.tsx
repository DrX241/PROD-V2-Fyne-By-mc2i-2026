    ...
    <div className="mb-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {currentRoom.characters.map((character) => (
          <Card
            key={character.id}
            className={`cursor-pointer transition-all duration-200 hover:-translate-y-1 overflow-hidden ${
          ...
          >
            <CardHeader className="flex flex-row items-center space-x-3 pb-2 px-4 py-3">
              <div className="relative flex-shrink-0">
                ...
                <span 
                  className={`absolute bottom-0 right-0 h-3 w-3 rounded-full border border-blue-900 ${
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center mt-1 flex-wrap">
                  <Badge
                    variant="outline"
                    className="text-xs px-1 py-0 h-5 bg-blue-800/50 text-blue-200 truncate max-w-[120px]"
                  >
