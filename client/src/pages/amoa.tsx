        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-12 sm:px-6 sm:py-16">
          ...
          >
            <p className="text-blue-200 max-w-2xl mx-auto">
              <span className="font-medium">ESPACE AMOA</span> utilise l'intelligence artificielle pour créer des expériences d'apprentissage immersives et adaptatives dans le domaine de l'assistance à maîtrise d'ouvrage.
            </p>
          </motion.div>
        </div>
      </div>
