...
import { DataSceneBackground } from '@/components/DataSceneBackground';

// Type pour le contenu des modules
type ModuleContent = {
  id: string;
  title: string;
  description: string;
          ...
          <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
                <div>
                  ...
                  <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
                    <li><span className="font-semibold">Entrées (x<sub>i</sub>)</span> : Données provenant de l'environnement ou d'autres neurones</li>
                    <li><span className="font-semibold">Poids (w<sub>i</sub>)</span> : Importance accordée à chaque entrée</li>
                    <li><span className="font-semibold">Biais (b)</span> : Décalage ajouté à la somme pondérée</li>
                ...
                <div className="bg-slate-800/50 p-3 rounded-md text-center border border-indigo-500/30">
                  <div className="font-mono text-xs md:text-sm">
                    <p>Sortie = f(Σ(w<sub>i</sub> × x<sub>i</sub>) + b)</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 rounded-md p-3">
                ...
                <p className="text-sm">f(x) = 1 / (1 + e<sup>-x</sup>)</p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 rounded-md p-3">
                ...
                <p className="text-sm">f(x) = (e<sup>x</sup> - e<sup>-x</sup>) / (e<sup>x</sup> + e<sup>-x</sup>)</p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-md p-3">
                ...
                <p className="text-sm">f(x<sub>i</sub>) = e<sup>x<sub>i</sub></sup> / Σ e<sup>x<sub>j</sub></sup></p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-green-500/10 border border-green-500/30 rounded-md p-3">
                ...
                <div className="bg-slate-800/50 p-2 rounded-md mt-2 overflow-x-auto">
                  <pre className="text-xs md:text-sm font-mono text-gray-300">
                    INSERT INTO nom_table (colonne1, colonne2)<br/>
