...
export default function DataIaRoleplay() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white pb-20 relative">
      <Helmet>
      ...
      {/* Contrôles */}
      <div className="flex justify-end max-w-7xl mx-auto px-4 mb-6 relative z-10">
        <div className="flex items-center gap-2">
          <Button 
            variant="outline" 
            size="sm"
            className={`border-indigo-500/30 text-indigo-300 hover:bg-indigo-900/20 ${highContrastMode ? 'bg-gray-800' : ''}`}
          ...
          <Button 
            variant="outline" 
            size="sm"
            className="border-indigo-500/30 text-indigo-300 hover:bg-indigo-900/20"
            onClick={() => {
