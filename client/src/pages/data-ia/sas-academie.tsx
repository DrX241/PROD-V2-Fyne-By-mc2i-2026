        ...
        <div className="px-8 py-8 relative max-w-[1600px] w-full mx-auto">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <DataButton 
                      ...
                      onClick={() => {
                        setCurrentTour('data-ia-sas-academie');
                        startTutorial();
                      }}
                    >
          ...
          >
            <h1 className="text-5xl font-bold mb-4 font-data-title relative">
              <span className="text-white">Choisissez votre mode</span>
              <br />
            ...
            <p className={`max-w-3xl mx-auto text-xl ${
              ...
              Sélectionnez la méthode d'apprentissage qui vous convient le mieux
            </p>
          </motion.div>
          ...
          <div className="mt-8 px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center max-w-5xl mx-auto">
              ...
              <motion.div 
                ...
                className={`cyber-edge-distort relative overflow-hidden p-6 ${
                  highContrastMode 
                    ...
                    : 'bg-gradient-to-br from-blue-600 to-indigo-900 border-2 border-blue-400/50 shadow-lg shadow-blue-500/50'
              ...
              >
                ...
                <h3 className="text-center text-2xl font-data-title mb-2">Mode Conversationnel</h3>
                <p className="text-center text-blue-300 mt-2">
                  Échangez avec un expert IA spécialisé
                </p>
                <div className="mt-6">
                  <p className="text-gray-300 text-center mb-4">
                    Discutez et apprenez à votre rythme avec un assistant IA spécialisé en Data Science et Intelligence Artificielle
                  </p>
                  <div className="text-center">
                    <Button 
                      className="bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white px-6 py-5 w-full"
                      onClick={(e) => {
                        setLocation('/data-ia/expert-learning');
                      }}
                    >
              ...
              >
                ...
                <h3 className="text-center text-2xl font-data-title mb-2">Mode Académique</h3>
                <p className="text-center text-blue-300 mt-2">
                  Explorez des modules de formation structurés
                </p>
                <div className="mt-6">
                  <p className="text-gray-300 text-center mb-4">
                    Accédez à des cours complets, tutoriels et exercices pratiques organisés par thèmes et niveaux
                  </p>
                  <div className="text-center">
                    <Button 
