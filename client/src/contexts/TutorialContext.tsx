...
const tourSteps: Record<string, Step[]> = {
  ...
  'cyber-mode-selection-redesign': [
    ...
    },
    {
      ...
      content: 'L\'onglet "Par métier" présente des parcours conçus pour différentes spécialités en cybersécurité : gouvernance, sécurité opérationnelle, test d\'intrusion, et autres domaines.',
      disableBeacon: true,
    },
    {
